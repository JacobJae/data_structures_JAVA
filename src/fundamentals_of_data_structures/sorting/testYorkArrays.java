...
public class testYorkArrays {
    ...
    public static void main(String[] args) {
        ...
        heap = Arrays.toString(a);
        
        startTime = System.nanoTime();
        Arrays.sort(b);
        endTime = System.nanoTime();
        System.out.println("Output Array (QuickSort):" + (endTime - startTime) / 1000 + " microseconds: " + Arrays.toString(b));
        quick = Arrays.toString(b);
        
        System.out.println(merge.equals(quick));
        System.out.println(heap.equals(quick));
    }
}
